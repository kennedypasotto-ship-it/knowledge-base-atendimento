...
{% hint style="info" %}
If you're evaluating the platform for your team rather than yourself, jump to [Core concepts](https://app.gitbook.com/s/U32cQ4M2m99nzFOoYF9k/core-concepts "mention") first — it'll save time when you set things up properly.
{% endhint %}
